...
func AnalyzeAllSyncOp() (*pointer.Result, []*instinfo.StOpValue) {
	...
	cfg := &pointer.Config{
		Mains:           ssautil.MainPackages(config.Pkgs),
		Reflection:      false,
		BuildCallGraph:  true,
		Queries:         queries,
		IndirectQueries: nil,
...
func WithdrawAllChan(stPtrResult *pointer.Result, vecStOpValue []*instinfo.StOpValue) (result []*instinfo.Channel) {
...
func WithdrawAllTraditionals(stPtrResult *pointer.Result, vecStOpValue []*instinfo.StOpValue) (result []*instinfo.Locker) {
